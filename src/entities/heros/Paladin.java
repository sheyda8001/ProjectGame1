...
public class Paladin extends Hero {
    ...
    private String heroName="PALADIN";
    private HeroPower heroPower=new HeroPower("mana",2,"add 2 minion 1/1 on the ground");
    private SpecialPower specialPower=new SpecialPower("PALADIN","+1/+1 random to a minion each endturn");
    public Paladin ()
    {
        fillCards();
    }
